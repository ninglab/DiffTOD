...
def get_dataset(name, mode, cache_dir=None, block_size=1024, num_proc=8):
    if name == "wikitext103":
        ...
        dataset = load_dataset('json', data_files='data/PersonaChat/PersonaChat_train.json')
        dataset['validation'] = Dataset.from_json('data/PersonaChat/PersonaChat_valid.json')
    elif name == "TopDial":
        dataset = load_dataset('json', data_files='data/TopDial/TopDial_train.json')
        dataset['validation'] = Dataset.from_json('data/TopDial/TopDial_valid.json')
    elif name == "cb":
        dataset = load_dataset('json', data_files='data/cb/cb_train.json')
        dataset['validation'] = Dataset.from_json('data/cb/cb_valid.json')
    else:
